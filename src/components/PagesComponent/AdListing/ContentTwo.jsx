    ...
    <>
      <div className="col-12">
        <div className="row formWrapper">
          ...
          <div className="col-12">
            <label className="auth_label" htmlFor="number">
              {t("phoneNumber")}
            </label>
            <input
              type="number"
          ...
          <div className="col-12">
            ...
            <input
              ...
              className={`${AdListingDetails.slug ? "bg" : ""}`}
              value={AdListingDetails.slug}
              type="text"
              name="slug"
              onChange={handleAdListingChange}
            />
          ...
          <div className="formBtns">
            <button className="backBtn" onClick={handleDeatilsBack}>
              {t("back")}
            </button>
            <button
              type="button"
